...
export const findAll = (options: any): Promise<any[]> => {
...
export const create = (createUser: any): Promise<any> => {
  const createdUser = new User(createUser);
  return createdUser.save();
};

export const update = (id: string, updateEmployee: any): Promise<any> => {
